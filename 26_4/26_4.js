  ...
  // 26-4호 · 2026 JAN-AUG 누계 기준으로 갱신 완료.
  // 카운트, 맥스값만 수정하면 됩니다.입문/베리에이션/브루잉 교육은 사업 계획대로 200명 목표로 잡았습니다.
  // 커핑 초급 교육은 26년 커핑 초급 대상자 인원입니다.
  // 점장/세컨 교육은 인원 대신 횟수로 적었습니다.
  const courses = [
  { name: '신규 입사자 입문 교육', count: 181,  max: 200, unit: '명' },
  { name: '커피 베리에이션 교육', count: 88,  max: 200, unit: '명' },
  { name: '브루잉 교육',          count: 62,  max: 200, unit: '명' },
  { name: '커핑 초급 교육',       count: 60,  max: 160, unit: '명' },
  { name: '점장/세컨 교육',       count: 7,  max: 13,  unit: '회' },
];
